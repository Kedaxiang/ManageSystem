        ...
        <el-container>
            <el-aside style="width: auto">
                <el-menu
                    ...
                    :collapse="isCollapse">
                    <!-- 一级菜单 -->
                    <el-submenu :index="String(index)" v-for="(item, index) in menuslist" :key="index" :disabled="!item.use">
                        <template slot="title">
                ...
                <el-main>
                    <nav style="margin-bottom: 20px;">
                        <el-breadcrumb separator="/">
                            <el-breadcrumb-item :to="{ path: '/home/advertising' }">首页</el-breadcrumb-item>
...
export default {
    ...
    data(){
        return{
            menuslist: [
                {pathName: '课程', children: [
                    {pathName: '课程管理', path: '/course/manage'},
                ],use:true},
                {pathName: '用户', children: [
                    {pathName: '用户管理', path: '/user/manage'},
                ],use:true}
            ],
